...
export function AppForm({ open, onOpenChange, app, saving, onSubmit }: Props) {
  ...
  function handleSubmit(event: React.FormEvent) {
    ...
    onSubmit({
      ...
      app_url: normalizeUrl(values.app_url),
      repo_url: normalizeUrl(values.repo_url),
      tags,
    });
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Guarde o que importa sobre cada projeto Vibe Coding.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="app_url">Link do app</Label>
              <Input
                id="app_url"
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={saving}>
              ...
              {app ? "Salvar alterações" : "Adicionar app"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
