...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AppShelf — sua estante de apps Vibe Coding" },
      {
        name: "description",
        content:
          "Cadastre, organize, favorite e acompanhe todos os aplicativos que você cria, em um portal pessoal.",
      },
      { property: "og:title", content: "AppShelf — sua estante de apps Vibe Coding" },
      {
